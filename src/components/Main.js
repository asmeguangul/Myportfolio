...
import myImage from './../assets/main page.png';
                ...
                <div className="flex flex-col justify-center sm:w-[70%] w-full sm:mr-5">
                    ...
                    <blockquote className="font-[800] text-[2rem] text-[#ec6e59;] mt-[-10px] lg:text-[2.4rem] md:text-[2rem] tm:text-[2.5rem] sm:text-[1rem]">
                        ...
                        <span className="before:block mx-4 mb-6 mt-4 before:absolute before:-inset-2 before:-skew-y-[3deg] before:bg-[#ec6e59;] relative inline-block">
                            <span className="relative text-[#fffffff0] dark:text-[#20262E]">Asme Guangul</span>
                        </span>
                    </blockquote>
                    ...
                    I am an Experienced Senior Java Developer with over 5 years of hands-on experience in Java application development.
I consistently demonstrate expertise in designing, coding and optimizing complex systems. Additionally, I have 4
years of experience as an Instructor, where I developed and designed computer science-related courses and curriculum.
Skilled in cross-functional collaboration, Agile methodologies, and fostering a collaborative development environment.
A dedicated and adaptable team player, capable of leading projects and collaborating effectively with diverse teams
to achieve successful outcomes.
                ...
                <div className="flex place-content-center mt-7 ">
                        <div className="flex flex-row sm:flex-col gap-4">
                            <a rel="noreferrer" href="https://www.linkedin.com/in/asmelash-abrha/" target="_blank">
